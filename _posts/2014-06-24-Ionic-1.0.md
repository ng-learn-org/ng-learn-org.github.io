---
layout: post
title: Ionic Framework is out
author: Santiago Esteva
image: http://ng-learn.org/img/ionic-logo-white.svg
categories: [news, protractor]
---

We have been using Ionic to create angularJs based tablet/mobile apps for a while now.
We like these guys. As always, we use ng-learn to publish news, articles and tutorials because it is useful to us and we hope it is for you too.
Ionic already released v1 and this is the change log from that point of time till now.
